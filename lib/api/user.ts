...
//
// /** [GET] /user/favourites - Returns user's favourites. */
// export const getFavourites = () => fetcher('/user/favourites', z.array(userModel.FavouriteModelSchema));
//
// /** [POST] /user/favourites/add - Adds a new favourite. */
// export const addFavourite = (payload: userModel.FavouriteRequest) =>
//     mutator('/user/favourites/add', 'post', apiModel.BasicResponseSchema, { arg: payload });
//
// /** [DELETE] /user/favourites/remove - Removes a favourite. */
// export const removeFavourite = (payload: userModel.FavouriteRequest) =>
//     mutator('/user/favourites/remove', 'delete', apiModel.BasicResponseSchema, { arg: payload });
