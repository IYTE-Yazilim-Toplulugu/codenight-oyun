...
export function GameHeader({ roomName, roomCode, showInfo, currentRound, totalRounds, timeRemaining }: GameHeaderProps) {
            ...
            <div className="flex items-center justify-between max-w-7xl mx-auto">
                <div className="flex items-center gap-3">
                    ...
                    <div className="bg-primary/10 px-4 py-2 rounded-xl border-2 border-primary/30">
                        ...
                        <p className="text-xl font-bold text-primary tracking-wider">{roomName}</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2 bg-secondary px-4 py-2 rounded-xl">
                        ...
                        {showInfo && <span className="font-semibold text-foreground">
                            Round {currentRound} of {totalRounds}
                        </span>}
                    </div>

                    {showInfo && <div className="flex items-center gap-2 bg-accent px-4 py-2 rounded-xl border-2 border-primary/20">
